...
def get_dataloader(
    ...
    if dataset == "cinic-10":
        trainset = torchvision.datasets.ImageFolder(
            root + "/cinic-10/trainval", transform=transform_train
        )
        testset = torchvision.datasets.ImageFolder(
            root + "/cinic-10/test", transform=transform_test
        )

    if dataset == "tiny_imagenet":
        num_workers = 16
        trainset = torchvision.datasets.ImageFolder(
            root + "/tiny_imagenet/tiny-imagenet-200/train", transform=transform_train
        )
        testset = torchvision.datasets.ImageFolder(
            root + "/tiny_imagenet/tiny-imagenet-200/val", transform=transform_test
        )
